...
#Set up a uniform magnetic field in the domain in the first frame:
solver_obj.frames[0].By[:,:] = 5e-2

#Create a particle object, defining its initial position velocity, charge and mass:
particle_1 = pic_solver.particle(25e-3, 50e-3, 0, 2e8, 1e-3, -constants_obj.q_e, constants_obj.m_e)
...
disp_interval = 16   #Display one frame in this many
disp_per_block = 100 #Run simulation for this many frames
