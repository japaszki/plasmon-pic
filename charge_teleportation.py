...
ke_init = 1 #initial energy in eV
v_init = math.sqrt(2 * ke_init * q_e / m_e)
barrier_width = 30e-9

#Don't add this particle to the solver until later
particle_1 = pic_solver.particle((surface_height-1)*dx + barrier_width, 0.5*Nz*dz, v_init, 0, particle_size, -q_e, m_e)
